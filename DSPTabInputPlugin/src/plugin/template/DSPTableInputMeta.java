 ...
 *
 */
public class DSPTableInputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
    DSPTableInputMeta retval = (DSPTableInputMeta) super.clone();
    return retval;
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new DSPTableInput( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new DSPTableInputData();
  }
